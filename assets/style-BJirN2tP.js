    ...
    <header class="header">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="./cotizar.html" class="${e.includes(`cotizar.html`)?`active`:``}"><i class="fa-solid fa-calculator"></i> Cotizar</a></li>
